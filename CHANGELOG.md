...
- Highlighted typed response matching in the package features.
...
- Corrected README examples to call `.request()` for direct API requests and start `.wait()` before triggering UI actions.

## [1.1.0] - 2026-07-28

### Added

- Added `exactUrlMatch` parameter to `RequestParameters` (defaults to `false`) to allow for exact URL matching during response interception.

## [1.0.2] - [1.0.8] - 2026-04-24
...
[1.1.5]: https://github.com/notNullThen/simple-api-playwright-nodejs/releases/tag/v1.1.5
